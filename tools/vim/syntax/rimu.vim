...
syn match rimuBar /|/ contained containedin=rimuURLParams,rimuMacroParams
...
syn match rimuMacroAssign /^{[0-9A-Za-z_-]\+}\s*=\s*'\_.\{-}'\n/
syn match rimuMacroValue /'\_.\{-}'\n/ contained containedin=rimuMacroAssign
syn match rimuMacroParam /$\d\+/ contained containedin=rimuMacroValue
