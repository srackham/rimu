#!/usr/bin/env node
!function(e){var t={};function o(i){if(t[i])return t[i].exports;var n=t[i]={i:i,l:!1,exports:{}};return e[i].call(n.exports,n,n.exports,o),n.l=!0,n.exports}o.m=e,o.c=t,o.d=function(e,t,i){o.o(e,t)||Object.defineProperty(e,t,{enumerable:!0,get:i})},o.r=function(e){"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})},o.t=function(e,t){if(1&t&&(e=o(e)),8&t)return e;if(4&t&&"object"==typeof e&&e&&e.__esModule)return e;var i=Object.create(null);if(o.r(i),Object.defineProperty(i,"default",{enumerable:!0,value:e}),2&t&&"string"!=typeof e)for(var n in e)o.d(i,n,function(t){return e[t]}.bind(null,n));return i},o.n=function(e){var t=e&&e.__esModule?function(){return e.default}:function(){return e};return o.d(t,"a",t),t},o.o=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},o.p="",o(o.s=0)}([function(e,t,o){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const i=o(1),n=o(2),r=o(3),a=o(4),s="/dev/stdin",l=process.env["win32"===process.platform?"USERPROFILE":"HOME"],c=n.resolve(l||"",".rimurc");function d(e){console.error(e),process.exit(1)}function h(e){e in a.resources||d(`missing resource: ${e}`);let t=a.resources[e].split("\\x60").join("`");return t=a.resources[e].split("\\x5C").join("\\"),t}let p,m=0,u="",g=!1,f=[],b=!1;process.argv.shift(),process.argv.shift();let y,x,k="";e:for(;x=process.argv.shift();)switch(x){case"--help":case"-h":console.log("\n"+h("manpage.txt")),process.exit();break;case"--version":console.log("11.1.9"),process.exit();break;case"--lint":case"-l":break;case"--output":case"-o":y=process.argv.shift(),y||d("missing --output file name");break;case"--pass":b=!0;break;case"--prepend":case"-p":k+=process.argv.shift()+"\n";break;case"--prepend-file":let e=process.argv.shift();e||d("missing --prepend-file file name"),f.push(e);break;case"--no-rimurc":g=!0;break;case"--safe-mode":case"--safeMode":m=parseInt(process.argv.shift()||"99",10),(m<0||m>15)&&d("illegal --safe-mode option value");break;case"--html-replacement":case"--htmlReplacement":p=process.argv.shift();break;case"--highlightjs":case"--mathjax":case"--section-numbers":case"--theme":case"--title":case"--lang":case"--toc":case"--no-toc":case"--sidebar-toc":case"--dropdown-toc":case"--custom-toc":case"--header-ids":case"--header-links":k+="{"+x+"}='"+(["--lang","--title","--theme"].indexOf(x)>-1?process.argv.shift():"true")+"'\n";break;case"--layout":case"--styled-name":u=process.argv.shift()||"",u||d("missing --layout"),k+="{--header-ids}='true'\n";break;case"--styled":case"-s":k+="{--header-ids}='true'\n",k+="{--no-toc}='true'\n",u="sequel";break;default:process.argv.unshift(x);break e}let _=process.argv;0===_.length?_.push(s):1!==_.length||""===u||"-"===_[0]||y||(y=_[0].substr(0,_[0].lastIndexOf("."))+".html");""!==u&&(_.unshift(`resource:${u}-header.rmu`),_.push(`resource:${u}-footer.rmu`)),!g&&i.existsSync(c)&&f.unshift(c),""!==k&&f.push("--prepend options"),_=[...f,..._];let v="",w=0,C={};void 0!==p&&(C.htmlReplacement=p);for(let e of _){"-"===e&&(e=s);let t="";if(e.startsWith("resource:"))e=e.substr("resource:".length),t=h(e),C.safeMode=0;else if("--prepend options"===e)t=k,C.safeMode=0;else{if(e===s)try{t=i.readFileSync(0,"utf-8")}catch(e){"EOF"!==e.code&&d(`error reading stdin: ${e.message}`)}else{i.existsSync(e)||d("source file does not exist: "+e);try{t=i.readFileSync(e).toString()}catch(t){d("source file permission denied: "+e)}}C.safeMode=f.indexOf(e)>-1?0:m}"html"===e.split(".").pop()||b&&e===s||(C.callback=function(t){let o=t.type+": "+e+": "+t.text;o.length>120&&(o=o.slice(0,117)+"..."),console.error(o),"error"===t.type&&(w+=1)},t=r.render(t,C)),t=t.trim(),""!==t&&(v+=t+"\n")}v=v.trim(),y&&"-"!==y?i.writeFileSync(y,v):process.stdout.write(v),w&&process.exit(1)},function(e,t){e.exports=require("fs")},function(e,t){e.exports=require("path")},function(e,t){e.exports=require("../lib/rimu")},function(e,t,o){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.resources={"classic-footer.rmu":String.raw`/*
...
PREDEFINED MACROS
  ...
  _______________________________________________________________`,"plain-footer.rmu":String.raw`</body>
</html>
